...
--NI_Text_ClearStep01_OFF					= 000 -- 2013.06.21 현재 사용 안함
NI_ESC_CHECK								= 122
...
--"ATTACK_2_PLASMA_SWORD" 			--플라즈마 스워드 대쉬공격
--"ATTACK_WEAK_PLASMA_SWORD"		--플라즈마 스워드 일반공격
--"ATTACK_STRONG_PLASMA_SWORD"		--플라즈마 스워드 강공격
--"ATTACK_STRONG1_PLASMA_SWORD"		--플라즈마 스워드 대쉬공격
--"ATTACK_JUMP_PLASMA_SWORD"		--플라즈마 스워드 점프공격
...
function InitPvETrigger()
	...
	OnPlasmaSwordLicenseTestStep01		(); -- step1 생성
