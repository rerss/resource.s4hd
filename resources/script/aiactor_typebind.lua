...
function TypeBind_AddNormalAIActorState()
	...
	animParam:SetAnim( "00074", 0, 1000, 0, true, 1.0, false );
...
function TypeBind_AddAttackAIActorState()
	...
	state:InitBindAIActorState( 250, 250, 250, 3000, 100.0, 3000.0 );
	state:RegisterSequence( 0, "Resources/Effects/skill_bind1.seq", "Resources/Sound/press_shot.ogg", 0, 2500 );


	local index = 0;
	ANIMPARAMLIST_NORMAL						= index; index = index + 1;	
	ANIMPARAMLIST_RECOVERY						= index; index = index + 1;	
	...
	animParam = StateFactory:GetAnimParam();
	animParam:SetAnim( "S0000", 0, 300, 0, false, 1.0, true );
	state:RegisterAnimParam( ANIMPARAMLIST_NORMAL, animParam );

	animParam = StateFactory:GetAnimParam();
	animParam:SetAnim( "S0001", 0, 300, 0, false, 1.0, true );
...
function TypeBind_AddAttackNormalLowerState( state )
	...
	animParam = StateFactory:GetAnimParam();
	animParam:SetAnim( "S0000", 0, 500, 0, true, 1.0, true );
