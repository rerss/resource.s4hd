...
--	TypeBossShota_AddStunAIActorState				();
--	TypeBossShota_AddCounterAttackDamage			();
	Common_AddIdleState								();
...
--	state:EnableCameraShake( true, 3000 );
--	state:SetCameraShakeFactor1( 500, 500, 50 );
--	state:SetCameraShakeFactor2( 0.15, 0.25, 3000, 5000 );
		
	state:InitAttackAIActorState( 5000, 0, false, false, 0.0, true );
	StateFactory:AddBossShota_LaserAttacks( state, 3200, 55.0, 10000.0 );
