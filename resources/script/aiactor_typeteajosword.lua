...
function TypeTeajoSword_AddAttack1AIActorState()
	...
	state:RegisterSound( "Resources/Sound/voice_man_attack_5.ogg", "Bip01", 0, 2500.0 );
	state:RegisterGhostTrail( "GhostTrail_counter_sword_01", 50, 600 );
	StateFactory:AddCounterSword1Attacks( state, 15.0, 500.0 );
...
function TypeTeajoSword_AddAttack2AIActorState()
	...
	state:RegisterSound( "Resources/Sound/voice_man_attack_2.ogg", "Bip01", 0, 2500.0 );
	state:RegisterGhostTrail( "GhostTrail_counter_sword_01", 50, 600 );
	StateFactory:AddCounterSword2Attacks( state, 15.0, 500.0 );
...
function TypeTeajoSword_AddAttack3AIActorState()
	...
	state:RegisterSound( "Resources/Sound/voice_man_attack_1.ogg", "Bip01", 0, 2500.0 );
	state:RegisterGhostTrail( "GhostTrail_counter_sword_01", 50, 600 );
	StateFactory:AddCounterSword3Attacks( state, 15.0, 500.0 );
...
function TypeTeajoSword_AddAttack4AIActorState()
	...
	state:RegisterSound( "Resources/Sound/voice_man_attack_4.ogg", "Bip01", 0, 2500.0 );
