...
function OnBurstshotgunLicenseTest()
	...
	OnBurstshotgunLicenseTestStep01		(); -- step1 생성
	OnBurstshotgunLicenseTestStep02		(); -- step2 생성
...
function OnBurstshotgunLicenseTestStep01()
	...
	--BurstshotgunLicense:Register(GateOpen_Step01);
